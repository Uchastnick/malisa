"config.py_" - ! необходимо переименовать либо скопировать в "config.py" !

"config.py" - файл основных параметров, храниться локально у пользователя.
...
"reactions_map.yaml" - карта реакций (действий) системы на определённые фразы пользователя.
 Изначально содержит базовую конфигурацию и определяет логику работы системы. Можно вносить изменения при необходимости.

"user_reactions_map.yaml" - карта пользовательских реакций (действий), на определённые фразы пользователя.
